...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'gs_dailywork'
        db.create_table(u'cmdb_gs_dailywork', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dailywork_date', self.gf('django.db.models.fields.DateField')()),
            ('dailywork_content', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('dailywork_charge', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('dailywork_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('dailywork_cost', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('dailywork_isover', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('dailywork_info', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'cmdb', ['gs_dailywork'])


    def backwards(self, orm):
        # Deleting model 'gs_dailywork'
        db.delete_table(u'cmdb_gs_dailywork')
    ...
    models = {
        ...
        u'cmdb.gs_dailywork': {
            ...
            'dailywork_charge': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            ...
            'dailywork_info': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'dailywork_isover': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
