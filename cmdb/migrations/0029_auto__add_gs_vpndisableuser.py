...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'gs_vpndisableuser'
        db.create_table(u'cmdb_gs_vpndisableuser', (
        ...
        db.send_create_signal(u'cmdb', ['gs_vpndisableuser'])


    def backwards(self, orm):
        # Deleting model 'gs_vpndisableuser'
        db.delete_table(u'cmdb_gs_vpndisableuser')
