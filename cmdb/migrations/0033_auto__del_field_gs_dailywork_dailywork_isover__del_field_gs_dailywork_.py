...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'gs_dailywork.dailywork_isover'
        db.delete_column(u'cmdb_gs_dailywork', 'dailywork_isover')

        # Deleting field 'gs_dailywork.dailywork_charge'
        db.delete_column(u'cmdb_gs_dailywork', 'dailywork_charge')

        # Adding field 'gs_dailywork.dailywork_subtype'
        db.add_column(u'cmdb_gs_dailywork', 'dailywork_subtype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'gs_dailywork.dailywork_isover'
        db.add_column(u'cmdb_gs_dailywork', 'dailywork_isover',
                      self.gf('django.db.models.fields.CharField')(default='0000-00-00', max_length=20),
                      keep_default=False)

        # Adding field 'gs_dailywork.dailywork_charge'
        db.add_column(u'cmdb_gs_dailywork', 'dailywork_charge',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Deleting field 'gs_dailywork.dailywork_subtype'
        db.delete_column(u'cmdb_gs_dailywork', 'dailywork_subtype')
    ...
    models = {
        ...
        u'cmdb.gs_dailywork': {
            'Meta': {'ordering': "['dailywork_content']", 'object_name': 'gs_dailywork'},
            'dailywork_author': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'dailywork_content': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'dailywork_cost': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'dailywork_date': ('django.db.models.fields.DateField', [], {}),
            'dailywork_info': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'dailywork_subtype': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'dailywork_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'cmdb.gs_domain': {
        ...
        u'cmdb.gs_vpndisableuser': {
            'Meta': {'ordering': "['-update']", 'object_name': 'gs_vpndisableuser'},
            ...
            'update': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '300'})
        },
        u'cmdb.gs_vpnmailinform': {
            'Meta': {'ordering': "['-update']", 'object_name': 'gs_vpnmailinform'},
            'cname': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'depname': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
        ...
        u'cmdb.gs_vpnuser': {
            'Meta': {'ordering': "['-update']", 'object_name': 'gs_vpnuser'},
            'cname': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'depname': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
