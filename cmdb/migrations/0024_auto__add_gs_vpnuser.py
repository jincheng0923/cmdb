...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'gs_vpnuser'
        db.create_table(u'cmdb_gs_vpnuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('update', self.gf('django.db.models.fields.DateField')()),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
        ))
        db.send_create_signal(u'cmdb', ['gs_vpnuser'])


    def backwards(self, orm):
        # Deleting model 'gs_vpnuser'
        db.delete_table(u'cmdb_gs_vpnuser')
