...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'gs_vpnuser.phone'
        db.alter_column(u'cmdb_gs_vpnuser', 'phone', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'gs_vpnuser.phone'
        db.alter_column(u'cmdb_gs_vpnuser', 'phone', self.gf('django.db.models.fields.IntegerField')())
