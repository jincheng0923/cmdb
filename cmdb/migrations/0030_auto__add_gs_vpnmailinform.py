...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'gs_vpnmailinform'
        db.create_table(u'cmdb_gs_vpnmailinform', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('cname', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('depname', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('update', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('info', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
        ))
        db.send_create_signal(u'cmdb', ['gs_vpnmailinform'])


    def backwards(self, orm):
        # Deleting model 'gs_vpnmailinform'
        db.delete_table(u'cmdb_gs_vpnmailinform')
