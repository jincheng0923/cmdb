...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'gs_dailywork.dailywork_author'
        db.add_column(u'cmdb_gs_dailywork', 'dailywork_author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


        # Changing field 'gs_dailywork.dailywork_info'
        db.alter_column(u'cmdb_gs_dailywork', 'dailywork_info', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):
        # Deleting field 'gs_dailywork.dailywork_author'
        db.delete_column(u'cmdb_gs_dailywork', 'dailywork_author')


        # Changing field 'gs_dailywork.dailywork_info'
        db.alter_column(u'cmdb_gs_dailywork', 'dailywork_info', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
