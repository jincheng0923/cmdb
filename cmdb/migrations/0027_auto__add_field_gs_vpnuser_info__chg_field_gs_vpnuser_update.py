...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'gs_vpnuser.info'
        db.add_column(u'cmdb_gs_vpnuser', 'info',
                      self.gf('django.db.models.fields.CharField')(default='unknow', max_length=500),
                      keep_default=False)


        # Changing field 'gs_vpnuser.update'
        db.alter_column(u'cmdb_gs_vpnuser', 'update', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):
        # Deleting field 'gs_vpnuser.info'
        db.delete_column(u'cmdb_gs_vpnuser', 'info')


        # Changing field 'gs_vpnuser.update'
        db.alter_column(u'cmdb_gs_vpnuser', 'update', self.gf('django.db.models.fields.CharField')(max_length=500))
